          ...
          <div className="relative lg:ml-10">
            ...
            <blockquote className="relative">
              <div className="text-2xl font-medium leading-9 text-gray-900">
                <p>
                  Après avoir organisé de nombreux événements avec Unsplash et
                  le Métro Photo Challenge, j'ai décidé de créer un club plus
                  formel. Afin que nous puissions continuer à nous amuser, à
                  apprendre, et à rencontrer d'autres photographes
                </p>
              </div>
